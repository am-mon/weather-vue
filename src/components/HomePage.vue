<template>
  <div class="container p-md-5 px-3 py-5">
    <h1 class="mb-5 text-color-01">Search Current Weather</h1>
    <form @submit.prevent="handleSubmit" class="row text-start mb-4" novalidate>
      <div class="col-12 col-md-4 my-1">
        <input
          type="text"
          class="form-control w-100 py-3 text-uppercase"
      ...
      <div class="col-12 col-md-4 my-1">
        <input
          type="text"
          class="form-control w-100 py-3 text-capitalize"
      ...
      <div class="col-6 col-md-2 my-1 pe-1">
        <button
          type="submit"
          class="form-control w-100 py-3 btn bg-color-01 text-white fw-bold"
        >
          Search
        </button>
      </div>
    ...
    <div v-else-if="error" style="color: #ff0000">
      Error: {{ error.message }}
    </div>
    <div v-else>
      <div v-if="data">
        <div class="bg-white mt-3 rounded overflow-hidden">
          <div class="row">
            <div class="col-12 col-md-6">
              <div
                class="bg-color-01 py-3 py-md-4 text-white w-100 h-100 d-flex flex-column justify-content-center"
              >
                <h4 class="text-capitalize fw-light">
                  {{ data.name }},
            ...
            <div
              class="col-12 col-md-6 py-3 py-md-4 d-flex flex-column justify-content-center"
    ...
    <div class="mt-5 pt-4" v-if="fetchHistory.length">
      ...
      <ul style="list-style: none" class="p-0">
        <li
          class="mb-3"
          v-for="(entry, index) in fetchHistory.slice().reverse()"
          :key="index"
        >
          ...
          <div class="bg-white mt-3 rounded overflow-hidden">
            <div class="row">
              <div class="col-12 col-md-6">
                <div
                  class="bg-color-01 py-3 py-md-4 w-100 h-100 d-flex flex-column justify-content-center text-white"
                >
                  <h4 class="text-white text-capitalize fw-light">
                    {{ entry.city }},
                    <span class="text-uppercase"> {{ entry.country }}</span>
                  </h4>
                  <div v-if="entry.weather_data">
                    ...
                    <h4 class="text-white fw-bold">
                      {{
                        (entry.weather_data.main?.temp - 273.15).toFixed(1)
                      }}°C ,&nbsp;
                      {{
                        (
                    ...
                    <div>
                      <img
                        ...
                        :src="
                          'https://openweathermap.org/img/wn/' +
                          entry.weather_data.weather[0].icon +
                          '@4x.png'
                        "
                      />
                      <h6 class="text-capitalize fw-bold">
              ...
              <div
                class="col-12 col-md-6 pt-4 pb-5 py-md-4 d-flex flex-column justify-content-center"
              ...
              >
                ...
                <div v-else>
                  ...
                  <p>
                    No data to show due to <br />incorrect city or country code.
                  </p>
                </div>
              </div>
            </div>
    ...
    <p class="mt-5 text-center">
      This site is developed by using Vue.js for a learning purpose.
    </p>
    <p class="text-center">
